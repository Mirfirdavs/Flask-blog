...
def register():
    ...
    if form.validate_on_submit():
        ...
        flash(f'Your accaunt has been created! You are now able to log in', 'success')
...
def account():
    ...
    if form.validate_on_submit():
        ...
        # Здесь какая-то ошибка нужно убрать session.add(), но без неё не работает
        db.session.commit()
    ...
    # Название image_file берется из Models class User
